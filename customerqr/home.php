 ...
 // echo "SELECT * from fnt_get_sninfo_qrcustomer_json_planb('".$sanitized_sn."','".$sanitized_mkey."');  ";
   ...
   //   echo "SELECT * from fnt_get_sninfo_qrcustomer_json('".$sn."')";
					...
					foreach ($resultado as $rowheaders) 
					{
						...
						$rstmm2 = $connect->prepare("SELECT * from fnt_get_sninfo_qrcustomer_json('".$sanitized_sn."' );  ");
					//	echo "SELECT * from fnt_get_sninfo_qrcustomer_json('".$sanitized_sn."' );  ";
						$rstmm2->execute();
						$resultado2 = $rstmm2->fetchAll();
						foreach ($resultado2 as $rowheaders2) 
						{
						 
							$phpValue2 = json_decode($rowheaders2[0]);
							$_v_sn=$phpValue2->sn;
							...
							$_v_file_pfoms=$phpValue2->v_file_pfoms;
							$v_file_fcs=$phpValue2->v_file_fcs;
							$_v_file_um=$phpValue2->v_file_um.".pdf";
						///	echo "aaaaaaaaaaaaaaaa".$phpValue2->v_file_um.".pdf";
							 $_v_filemanualcyber=$phpValue2->idatribmanualcyber.".pdf";
						...
						/*
					 	  $vprojectname = $rowheaders[0];
						 $phpValue = json_decode($rowheaders[0]);
                   		   $vprojectname = $rowheaders[0];
						  $phpValue = json_decode($rowheaders[0]);
				//	   echo $rowheaders[0];
					 echo $phpValue->v_sku."<br>"; // Salida: Juan
					//	echo $phpValue->band0key."<br>"; // Salida: Pérez
					//	echo $phpValue->edad."<br>"; // Salida: 30
						 $_v_sn=$phpValue->sn;
 
						 $_band0key =$phpValue->band0key;
						 $_band1key=$phpValue->band1ey;
						 $_maxpwrkey=$phpValue->maxpwrkey;
						 $_classkey=$phpValue->classkey;
						 $_qrcustomer=$phpValue->qrcustomer;
						 $_v_idsosn=$phpValue->v_idsosn;
						 $_v_skuso=$phpValue->v_skuso;
						 $_v_sku=$phpValue->v_sku;
						 $_v_skudescrip=$phpValue->v_skudescrip;
						 $_v_file_pfoms=$phpValue->v_le_pfoms;
						 $v_file_fcs=$phpValue->v_file_fcs;
						 $_v_file_um=$phpValue->v_file_um;
						  $_v_file_um='LS10267-000-E_C.pdf'; 
					*/
        ...
        <main class="container">
            <div class="bg-body-tertiary p-4 rounded">
                ...
                <div class="container-fluid" id="qr-reader">
                   ...
                   <p style="font-size:14px; text-align: center;color:red">the scanned qr code does not correspond to a company.
                SN.  <br>  <br>	 <br>  <br>	
...
function redirectToHomepage() {
  ...
  setTimeout(function() {
    ...
    window.location.href = "https://www.flexbda.com/customersqr/";
  }, 2000);
}

// Call the function to initiate the redirect after 2 seconds
redirectToHomepage();
</script>
                    ...
                    <div class="tab-content p-0">
                        ...
                        <div class="col-sm-8 invoice-col">
                            ...
                            <address>
								...
								<?php if ($_v_filemanualcyber !='.pdf')
										{
											?>
											  <address>
                                <p style="font-size:12px">
                                    <strong>Cybersecurity - Product Security<span class="colorazulfiplex">  </span> </strong>||
                                ...
                                <div class=" ">
                                    ...
                                    <a href="manuals/<?php echo $_v_filemanualcyber; ?>"  target="_blank"
                                        class="btn btn-outline-dark btn-sm "> <i class="ion ion-android-archive"></i>
                                        View and Download</a>
                                </div>
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-content p-0">
                            ...
                            <div class="col-sm-8 invoice-col">
								...
								<?php 
							///	echo "aaaa".$_v_filemanualcyber;
								if ($_v_filemanualcyber !='.pdf')
										{
											?>
											  <address>
                                <p style="font-size:12px">
                                    <strong>Cybersecurity - Product Security<span class="colorazulfiplex"> </span> </strong> <br>
                                </p>
