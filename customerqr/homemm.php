  ...
  echo "SELECT * from fnt_get_sninfo_qrcustomer_json_planb('".$sanitized_sn."','".$sanitized_mkey."');  ";
   ...
   //   echo "SELECT * from fnt_get_sninfo_qrcustomer_json('".$sn."')";
					...
					foreach ($resultado as $rowheaders) 
					{
						...
						echo "<br>SELECT * from fnt_get_sninfo_qrcustomer_json('".$sanitized_sn."' );  ";
						$rstmm2->execute();
						...
						foreach ($resultado2 as $rowheaders2) 
						{
							...
							$_v_file_pfoms=$phpValue2->v_le_pfoms;
...
<body class="container">
    ...
    <div class="d-xl-none">
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="#" onclick="view_tabcel(11)" class="small-box-footer">Download <i
        ...
        <div class="card d-none" id="tabinfocel" name="tabinfocel">
  ...
  ?>
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="#" onclick="view_tab(1)" class="small-box-footer">Download <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
  ...
  else
  {
   ...
   ?>
            ...
            <div class="card d-none" id="tabinfo" name="tabinfo">
                <div class="card-header2 ui-sortable-handle bg-info" style="cursor: move;">
                    <h3 class="card-title">
                        <i class="ion ion-clipboard"></i>
                        Device Information
                                    ...
                                    <div class=" ">
                                        ...
                                        <a href="manuals/<?php echo $_v_file_um; ?>" target="_blank"
                                            class="btn btn-outline-dark btn-sm "> <i
                                                class="ion ion-android-archive"></i> Download</a>
                                    </div>
                                </address>
                            </div>
                            <!-- /.col -->
