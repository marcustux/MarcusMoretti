...
session_unset();
  ...
  $vidp = 0;
   ...
   if(preg_match($regexNum, $_REQUEST['idtoke']) && preg_match($regexNum, $_REQUEST['idr'])){
...
<head>
  ...
  <link rel="stylesheet" href="createtksuppormm.css">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Request Support</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Request Support </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="frmsndtckt" name="frmsndtckt">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">
                    <span class="colorazulhoneywell letramasgrande">Create a support ticket for the project #F0<?php echo $vidp." -  Rev.".$vidr ;  ?> </span></label>
                    
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Description of the problem</label>
                  ...
                  <input type="hidden" class="form-control" id="idpp" name="idpp" value="<?php echo $vidp ;?>">
                ...
                <p align="right">
                  <button type="button" name="abc" id="abc" onclick="sendTicket()" class="btn btn-primary">Send </button>
        ...
        <!-- Main row -->
        <div class="row">
        <!-- <input type="hidden" class="form-control" id="hhhh" name="hhhh" value="<?php echo 	$token;?>"> -->
        </div>
        <!-- /.row (main row) -->
      </div><!-- /.container-fluid -->
    </section>
...
function sendTicket() {
    ...
    if (hagosubtmit == 'S') {
        ...
        const form = document.querySelector('#frmsndtckt');
