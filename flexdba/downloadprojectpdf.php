...
try {
        ...
        /*     $vprject = $_SESSION['pdf']['idp']; ///
            $vaccion = $_SESSION['pdf']['idcc']; ///
            $v_natt = $_SESSION['pdf']['natt']; ///
            $activa = $_SESSION['pdf']['activate']; /// */
                        ...
                        //     $rstmm->bindParam(':tokengoogle', $activa);		
                            ...
                            foreach ($resultado as $rowheaders) 
                                        ...
                                        $projectdraft = $rowheaders['idproject'];
                                            ...
                                            $designtrans = $rowheaders['designtransition'];
...
//AQUI VA LO NUEVO DEL HTML IF-ELSE
...
else
{
   ...
   <p>Your purchase of the products and services listed in this quote is governed solely by the Terms and Conditions of sale (available at https://www.fiplex.com/download/Fiplex-TandC-of-Sales-02182022.pdf), together with the terms of any signed agreement you may have with Fiplex or its affiliated entities. Any conflicting, additional, and/or different terms or conditions on your Order or any other instrument you provide are deemed to be material alterations and are rejected and will not be binding upon Fiplex or its affiliated entities.</p>
     <br><br>';
        ...
        function generateFileNameattach()
        {
        ...
        $fileName = generateFileNameattach();

                // Logo
        

        //Close and output PDF document
        /* $directorio="/pdfattach";
        if(file_exist) */
        ...
        ob_end_clean();
            ...
            if($entornoActual=='DEV'){
                ...
                // LC
                $pdf->Output('C:/laragon/www/SiteFLEXBDA/repositorio-fiplex/pdfattach/'.$fileName.'.pdf', 'I');

                // LL
                // $pdf->Output('/Users/leandroleuci/Macbook (local)/repositorio-fiplex/pdfattach/'.$fileName.'.pdf', 'I');


            }else if($entornoActual=='TST'){

                $pdf->Output('/var/www/flexbda/testing/pdfattach/'.$fileName.'.pdf', 'I');
        ...
        else
        {
            ...
            if($entornoActual=='DEV'){
                ...
                // LC
                // $pdf->Output('C:/laragon/www/SiteFLEXBDA/repositorio-fiplex/pdfattach/'.$fileName.'.pdf', 'F');

                // LL
                $pdf->Output('/Users/leandroleuci/Macbook (local)/repositorio-fiplex/pdfattach1111/'.$fileName.'.pdf', 'F');

            }else if($entornoActual=='TST'){

                $pdf->Output('/var/www/flexbda/testing/pdfattach/'.$fileName.'.pdf', 'F');
