...
include("db_conectflexbda.php"); 
                    ...
                    $senten_buscabanda = $connectaudit->prepare("select * from flexbdahoneywell_band where idproject= :idproject and idrev=:idrev and typeref ='FREQBAND' ");
  ...
  $designtransition = $rowheaders['designtransition'];
  ...
  $namedellerchannel =  str_replace("_"," ", $rowheaders['esdchanneldealer']);
      ...
      $vtxinexc700 = $rowheaders['inexc700'];
      $vtxinexc800 = $rowheaders['inexc800'];
      ...
      $vinstallationduedate = substr ($rowheaders['installationduedate'],0,10);
                    ...
                    <div class="">
                         ...
                         <?php echo "<br>Special Instructions: ".$vdr_special; ?></p>
                          ...
                          <div class="entornoactualdiv" style="visibility: hidden" id="entornoactualdiv" value="<?php echo $entornoActual;?>"></div>	
                          <div class="form-group col-md-12   ">
...
Latitude:</th>
          ...
          <div class="col-sm-12" id="listachannel" name="listachannel">
                <table class="table table-striped table-sm ">
                      ...
                      <tbody>
                              ...
                              <?php if($_SESSION['flexesdchandeal']=='FIPLEX_SI' && ($vtxtbdadloutputpoweruhf != '' || $vtxtbdadloutputpowerVhf != ''))
                                    { ?>
                                      <table class="table col-6">

                                          <tbody>
                                          <?php if($vtxtbdadloutputpoweruhf !='')
                                                { ?>
                                                  <tr>
                                                    <th scope="row">BDA DL Output power - UHF:</th>
                                                    <td ><?php echo $vtxtbdadloutputpoweruhf; ?> </td>
                                                  </tr>
                                          <?php }

                                                if($vtxtbdadloutputpowervhf !='')
                                                { ?>
                                                  <tr>
                                                    <th scope="row">BDA DL Output power - VHF:</th>
                                                    <td ><?php echo $vtxtbdadloutputpowervhf; ?> </td>
                                                  </tr>
                                          <?php } ?>
                                  ...
                                  <table class="table table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <?php
                                          if($vtxinexc700==1){
                                              echo 'Exclude ESMR band (DL: 862-869MHz, UL: 817-824MHz), only include Band 14 (HONBDA-7S27B-IB-10)';
                                            }
                                              if($vtxinexc700==2){
                                                echo 'Exclude Band 14 (DL: 758-768MHz, UL 788-798MHz) and ESMR Band (DL:862-869MHz, UL: 817-824MHz) - (HONBDA-7S27B-IB-06)';
                                              }
                                                  if($vtxinexc700==3){
                                                    echo 'Include Band 14 and ESMR band (HONBDA-7S27B-IB-18)';?></b>  <?php
                                                  }
                                                  ?> </td> 
                                                  <td colspan=3> </td>
                                        </tr>
  ...
  <tbody>
    ...
    <tr>
      <th id="thdistance" scope="row">Distance to Donor Site:</th>
      <td id="tddistance"><?php echo $vtxtdistdonorsite; ?></td>
  ...
  <tbody>
    <tr>
      <th id="thwhichfloor" scope="row">Which Floor will the BDA be located on?:</th>
      <td id="tdwhichfloor"><?php echo $vbda_floordba; ?></td>
  ...
  <tr>
    <td colspan=1><b>Battery Backup Requirement:</b>  <?php
        $name_BBU_select ="No BBU needed";
             if($vvbbu_req ==12) { echo " 12 hours"; $name_BBU_select ="HONBDA-BTTY-100055";  }
             if($vvbbu_req ==24) { echo "24 hours"; $name_BBU_select ="HONBDA-BTTY-100-NG"; }
              //if($vvbbu_req ==24) { echo "24 hours"; $name_BBU_select ="HONBDA-BTTY-100100"; } HONBDA-BTTY-100-NG
    ?></ts>
    <td colspan=3> </td>
                         ...
                         <div class="form-group col-md-12 ">
                          ...
                          <table class="table table-striped">
                              ...
                              <tbody>
                                <tr>
                                  <?php
                                  if($designtransition != "quickquote")
                                  { ?>
                            ...
                            <?php } ?>
                                  ...
                                  <td>
                                  <?php   if($valarm_req_annuciator == "YES - With dry contacts to feed the FACP") { echo "YES - With dry contacts to feed the FACP "; } 
                                    if($valarm_req_annuciator =="YES - Without dry contacts. BBU to feed FACP") { echo "YES - Without dry contacts. BBU to feed FACP"; } 
...
///////////////////////REGENERAMOS Y BUSCAMOS DE NUEVO EL BDA POSIBLE
           ...
           ///   ----- -89.77 > -95
            if (  floatval  ($rssimobile27) > floatval  ( $v_txtmindlcoverage))
            {
                $maswhererssi= "  AND fiplexpartnro LIKE '%27%'";
           ///     echo "SIIIIIIIIIIIIIIIIIII 27";
            }
            else
            {
                if (floatval  (   $rssimobile33) >  floatval  ($v_txtmindlcoverage))
                {
                    $maswhererssi= "  AND fiplexpartnro LIKE '%33%'";
             ///       echo "SIIIIIIIIIIIIIIIIIII 33333";
                }

            }
           //// aaaaaaaaaaaaaaaaa                   ***-89.77****-83.77***-95
         ////   echo "aaaaaaaaaaaaaaaaa". $maswhererssi."***".$rssimobile27."****". $rssimobile33."***".$v_txtmindlcoverage."-----". floatval  ($rssimobile27) ;
...
<table class="table table-striped table-sm  " id="sss">
    ...
    <td scope="col" class="tablecabenegro" colspan=5>&nbsp;</td>
      <td scope="col" class="tablecabenegro d-flex justify-content-end" colspan=3>ESD Labor Est (Hrs.)</td>
    </tr>
    </table>
...
//echo $sqlbuscabda."<br>";
  $sql = $connect->prepare(  $sqlbuscabda);
    ...
    foreach ($resultadomm as $row2) {
      $entro=1;
         ...
         $detect_partnumberhoneywel =  $row2['fiplexpartnro'];
          ...
          //LL
         $esdlaborlow = $row2['hslow_'.$nombrecampo];
         $esdlaborhigh = $row2['hshigh_'.$nombrecampo];
   ...
   //  echo "-------------a1";
    ...
    //   echo "a1";
      ...
      $sentenciaaction->bindParam(':netprice', $detect_price);	 
      $sentenciaaction->bindParam(':nettotal', $elmontoamostrar);	 

      //LL
      $sentenciaaction->bindParam(':hslow_'.$nombrecampo, $esdlaborlow);	 
      $sentenciaaction->bindParam(':hshigh_'.$nombrecampo, $esdlaborhigh);	 
  ...
  //   echo "atest m.".$eltotal;
      ?></td>
      <td><?php echo $esdlaborlow; ?></td>
      <td><?php echo $esdlaborhigh; ?></td>
    </tr>
       <?php
      $eltotal_hrlow =   $eltotal_hrlow  + $esdlaborlow;
      $eltotal_hrhigh = $eltotal_hrhigh + $esdlaborhigh;
     }
     else
     {
      if ($v_result_bdasuggestion =="MM_UHFVHF")
      {
        if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
        {
          ?>
           <tr>
  ...
  $sql = $connect->prepare(  $sqlbuscabda);
   ...
   //  echo "-------------a1";
    ...
    //   echo "a1";
      ...
      $canthrlow = 0;
      $canthrhig = 0;
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");   
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
      $sentenciaaction->bindParam(':description', $detect_description);	 
...
<!--Trilogy Connector BDA-NMP01250-->
<?php
 $detect_partnumberfiplex = "";
 $entro=0;
 $elmontoamostrar = 0;
 ...
 $esdlaborhigh = -1;
  ...
  $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-NMP01250'";
...
<!--Trilogy Connector BDA-NFP01250-->
<?php
 $detect_partnumberfiplex = "";
 $entro=0;
 $elmontoamostrar = 0;
 ...
 $esdlaborhigh = -1;
  ...
  $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-NFP01250'";
...
<?php
 ...
 $esdlaborhigh = -1;
  ...
  $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-NM-RN4P-10-NM'";
...
if ($valarm_req_annuciator=="YES - With dry contacts to feed the FACP")
{
...
//echo "SI";
 ...
 $esdlaborhigh = -1;
  ...
  $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='HONBDA-BTTY-ANN-5'";
//echo $sqlbuscabda."<br>";
  $sql = $connect->prepare(  $sqlbuscabda);
    $sql->execute();
    $resultadomm = $sql->fetchAll();
   ...
   //   echo "atest m.".$eltotal;
    ...
    if ($valarm_req_annuciator=="YES - Without dry contacts. BBU to feed FACP")
    {
    ...
    //echo "SI";
     ...
     $esdlaborhigh = -1;
      ...
      $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='HONBDA-BTTY-ANN-6'";
...
---VHF --->   ANT-OI-14S-001  -- BDA-OIA-1301000-2
  ...
  */
  $sqldasantena="select * from flexbda_products_budget where 1=0";

  if ($v_result_bdasuggestion =="MM_UHFVHF")
  {
    if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
    {
      $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-OIA-1301000-2'";
    }
    else
    {
      $sqldasantena="select * from flexbda_products_budget where 1=0";
  ...
  else
  {
    if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
    {
      $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-FA-763869-2-2'";
    }
    else
    {
      $sqldasantena="select * from flexbda_products_budget where 1=0";
...
if( $channelcountUHF ==0 && $channelcountVHF ==0 )
{
  if( $channelcount700 >0 || $channelcount800>0   )
  {
    ...
    if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
    {
      $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-OIA-698869-3-1'";
    }
    else
    {
      $sqldasantena="select * from flexbda_products_budget where 1=0";
  ...
  if( $channelcountUHF ==0 && $channelcountVHF >0  && $channelcount700 ==0 && $channelcount800 ==0 )
    {
      if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
      {
        $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-FA-150175-2-1'";
      }
      else
      {
        $sqldasantena="select * from flexbda_products_budget where 1=0";
    ...
    if( $channelcountUHF >0 && $channelcountVHF ==0  && $channelcount700 ==0 && $channelcount800 ==0 )
    {
      ...
      if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
      {
        $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-OIA-350600-2-1'";
      }
      else
      {
        $sqldasantena="select * from flexbda_products_budget where 1=0";
...
*/
 ...
 $esdlaborhigh = -1;
    ...
    break;
     ...
     if (  $entro ==1)
     {
      ...
      $esdlaborlow_mul = ($quantity * 0.16); 
      $esdlaborhigh_mul = ($quantity * 0.25); 
      ...
      //LL  
      $sentenciaaction->bindParam(':hslow_'.$nombrecampo, $esdlaborlow_mul);	 
      $sentenciaaction->bindParam(':hshigh_'.$nombrecampo, $esdlaborhigh_mul);	
 ...
 <?php
	...
	//  echo "AAAA===> ".$sqldasantena;
      }
     }

     if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
     {
        $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-TP6-L2' LIMIT 1";
     }
     else
     {
       $sqldasantena="select * from flexbda_products_budget where 1=0";
  ...
  /*BDA-DC6-L2	RF DIRECTIONAL COUPLER, 136-870 MHz, 6dB, 200W. Final coupler value to be determined after design completion. DC6 for estimation purposes only.*/
  $entro=0;
  $detect_description="";
  $detect_price="";
  $detect_partnumberfiplex="";
...
//echo "HOLa COUPLER".$entro."$$$$". $detect_price;
     if (  $entro ==1)
     {
      ...
      $elmontoamostrarsolitosinsimb =  str_replace("$"," ",$detect_price); 
      $elmontoamostrarsolitosinsimb =  str_replace(",",".",$elmontoamostrarsolitosinsimb); 
      $canthrlow = ($v_resul_directcouplersplitter* $esdlaborlow); 
      $canthrhig = ($v_resul_directcouplersplitter* $esdlaborhigh);
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
      ...
      $sentenciaaction->bindParam(':nettotal', $elmontoamostrar);	 
      //LL 
      $sentenciaaction->bindParam(':hslow_'.$nombrecampo, $canthrlow);	 
      $sentenciaaction->bindParam(':hshigh_'.$nombrecampo, $canthrhig); 
  ...
  ?>
   ...
   //   echo "<br>atest m.".$eltotal;
      ?></td>
      <td><?php  if ($v_resul_directcouplersplitter >=0)
      {    echo ($v_resul_directcouplersplitter * $esdlaborlow); } ?></td>
      <td><?php  if ($v_resul_directcouplersplitter >=0)
      {    echo ($v_resul_directcouplersplitter * $esdlaborhigh);
      
      $eltotal_hrlow =   $eltotal_hrlow  + ($v_resul_directcouplersplitter * $esdlaborlow); 
      $eltotal_hrhigh = $eltotal_hrhigh +  ($v_resul_directcouplersplitter * $esdlaborhigh);
      }
   //   echo "<br>atest l.".$eltotal_hrlow;
    //  echo "<br>atest h.".$eltotal_hrhigh;
      ?></td>
...
<?php
    ...
    if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
    {
      $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-AP6012J50RD-1'"; 
      //$sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-ICA12-JPLLR-1K'"; DISCONTINUED
    }
    else
    {
      $sqlbuscabda="select * from flexbda_products_budget where 1=0";
    }
    //echo $sqlbuscabda."<br>";
      $sql = $connect->prepare(  $sqlbuscabda);
        $sql->execute();
...
//*****BDA-GNDKIT1	Coaxial Cable Grounding Kit***
//$quantity =$v_resul_dasantennacount;//formula old 21/04/21 FIP7
$quantity = 1 * $v_resul_donorantenncount;//FIP 7
$elmontoamostrar =  ($price_cable * $quantity );
number_format($elmontoamostrar, 2, '.', ',');


$elmontoamostrarsolito =   $price_cable ;
$canthrlow = ($quantity * 0.5);
$canthrhig = ($quantity * 1);
$sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
$sentenciaaction->bindParam(':idproject', $vidp);
$sentenciaaction->bindParam(':idrev', $vidr);	 
$sentenciaaction->bindParam(':sku', $detect_partselect);
...
?>
    <tr>
      ...
      $eltotal =  $eltotal +  ($price_cable *   $quantity);
      ?></td>
      <td><?php echo ($v_resul_dasantennacount * $esdlaborlow); ?></td>
      <td><?php echo ($v_resul_dasantennacount * $esdlaborhigh);
      
      $eltotal_hrlow =   $eltotal_hrlow  + ($v_resul_dasantennacount * $esdlaborlow); 
      $eltotal_hrhigh = $eltotal_hrhigh +  ($v_resul_dasantennacount * $esdlaborhigh);
    //  echo "<br>atest l.".$eltotal_hrlow;
   //   echo "<br>atest h.".$eltotal_hrhigh;
      ?></td>
    </tr>
...
*/
//$quantity =$v_resul_donorantenncount;//formula old 21-04 FIP8

$quantity = 2 * $v_resul_donorantenncount;////FIP8
$elmontoamostrar =  ($price_cable * $quantity );
number_format($elmontoamostrar, 2, '.', ',');
$elmontoamostrarsolito = $price_cable; 
$canthrlow =($quantity * 0.25);
$canthrhig =($quantity * 0.5);
$sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
$sentenciaaction->bindParam(':idproject', $vidp);
$sentenciaaction->bindParam(':idrev', $vidr);	 
$sentenciaaction->bindParam(':sku', $detect_partselect);
...
?>
    <tr>
      ...
      ?></td>
      <td><?php echo ($v_resul_donorantenncount * $esdlaborlow); ?></td>
      <td><?php echo ($v_resul_donorantenncount* $esdlaborhigh);
      
      $eltotal_hrlow =   $eltotal_hrlow  + ($v_resul_donorantenncount* $esdlaborlow); 
      $eltotal_hrhigh = $eltotal_hrhigh +  ($v_resul_donorantenncount* $esdlaborhigh);
    //  echo "<br>atest l.".$eltotal_hrlow;
   //   echo "<br>atest h.".$eltotal_hrhigh;
      ?></td>
    </tr>
 ...
 <?php
  ...
  if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
  {
    $sqldasantena="select distinct    flexbda_products_budget.*	FROM public.flexbda_products_budget where  (description  LIKE '%connector%') and familyname like '%CONNECTOR%' and familyname like '%MALE%' and familyname not like '%FEMALE%'  ";
  }
  else
  {
    $sqldasantena="select distinct    flexbda_products_budget.*	FROM public.flexbda_products_budget where 1=0";
  }
  ...
  $esdlaborhigh = -1;
    ...
    break;
     ...
     if (  $entro ==1)
     {
      ...
      $elmontoamostrarsolitosinsimb =  str_replace("$"," ",$detect_price); 
      $elmontoamostrarsolitosinsimb =  str_replace(",",".",$elmontoamostrarsolitosinsimb); 
      $canthrlow = ($v_resul_dascoaxconnect* $esdlaborlow); 
      $canthrhig = ($v_resul_dascoaxconnect* $esdlaborhigh);
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
  ...
  ?>
    <tr>
      ...
      ?></td>
      <td><?php  if ( $v_resul_dascoaxconnect>0)
      { echo ($v_resul_dascoaxconnect* $esdlaborlow); } ?></td>
      <td><?php  if ( $v_resul_dascoaxconnect>0)
      { echo ($v_resul_dascoaxconnect* $esdlaborhigh); 
      
      $eltotal_hrlow =   $eltotal_hrlow  + ($v_resul_dascoaxconnect* $esdlaborlow); 
      $eltotal_hrhigh = $eltotal_hrhigh +  ($v_resul_dascoaxconnect* $esdlaborhigh);
      }
      ?></td>
    </tr>
...
if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
{
  $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-P8AX09-6G-N/FF'";
}
else
{
  $sqlbuscabda="select * from flexbda_products_budget where 1=0";
  ...
  $esdlaborhigh = -1;
    ...
    break;
     ...
     if (  $entro ==1)
     {
      ...
      $elmontoamostrarsolitosinsimb =  str_replace("$"," ",$detect_price); 
      $elmontoamostrarsolitosinsimb =  str_replace(",",".",$elmontoamostrarsolitosinsimb); 
      $canthrlow = ($v_resul_donorantenncount * 0); 
      $canthrhig = ($v_resul_donorantenncount * 0);
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
 ...
 <?php
    ...
    if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
    {
      $sqlbuscabda="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-NM-RG8-13-NM'";
    }
    else
    {
      $sqlbuscabda="select * from flexbda_products_budget where 1=0";
  ...
  $entro=0;
    ...
    break;
     ...
     if (  $entro ==1)
     {
      ...
      $canthrlow = ($v_resul_jumpercablecount* $esdlaborlow); 
      $canthrhig = ($v_resul_jumpercablecount* $esdlaborhigh);
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
...
echo "error".$v_resul_jumpercablecount; 
      ...
      { echo ($v_resul_jumpercablecount* $esdlaborlow); } ?></td>
      <td><?php  if ( $v_resul_jumpercablecount>0)
      { echo ($v_resul_jumpercablecount* $esdlaborhigh); 
      
      $eltotal_hrlow =   $eltotal_hrlow  + ($v_resul_jumpercablecount* $esdlaborlow); 
      $eltotal_hrhigh = $eltotal_hrhigh +  ($v_resul_jumpercablecount* $esdlaborhigh);
      }
      ?></td>
    </tr>
    ...
    if( $channelcountUHF ==0 && $channelcountVHF ==0 )
    {
      if( $channelcount700 >0 || $channelcount800>0   )
      {
        if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
        {
          $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-YDA763869-14-1'";
        }
        else
        {
          $sqldasantena="select * from flexbda_products_budget where 1=0";
    ...
    else
    {
      if($_SESSION['flexesdchandeal'] != "FIPLEX_SI" || $designtransition != "quickquote") 
      {
        ...
        {
           // vamos x VHF
          $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-YDA150175-11-1'";
        }
        if( $channelcountUHF >0 && $channelcountVHF ==0  && $channelcount700 ==0 && $channelcount800 ==0 )
        {
         // vamos x UHF
         $sqldasantena="select * from flexbda_products_budget where migrate ='Y' and fiplexpartnro ='BDA-DDA450512-2-1'";
        }
  ...
  $esdlaborhigh = -1;
    ...
    break;
     ...
     if (  $entro ==1)
     {
      ...
      $canthrlow = ($v_resul_donorantenncount* $esdlaborlow); 
      $canthrhig = ($v_resul_donorantenncount* $esdlaborhigh);
      $sentenciaaction = $connect->prepare("INSERT INTO public.flexbdahoneywell_bugdet(idproject, idrev, sku, description, quantity, netprice, nettotal, esdlaborhow, esdlaborhigh, orderreport)  VALUES (:idproject, :idrev, :sku, :description, :quantity, :netprice, :nettotal, :hslow_".$nombrecampo.", :hshigh_".$nombrecampo.",:orderreport);");
      $sentenciaaction->bindParam(':idproject', $vidp);
      $sentenciaaction->bindParam(':idrev', $vidr);	 
      $sentenciaaction->bindParam(':sku', $detect_partselect);
...
<table class="table table-striped table-sm" id="makeEditable">
  ...
  $rstmm = $connect->prepare("SELECT * FROM flexbdahoneywell_bugdet WHERE idproject= :idproject and idrev =:idrev order by netprice desc ");
  $rstmm->bindParam(':idproject', $vidp);		
  $rstmm->bindParam(':idrev', $vidr);		
$rstmm->execute();
$resultado = $rstmm->fetchAll();		
...
<?php 
  if ( $activeproy <> "Y"  && 	$_SESSION["flexbdag"]  <> "RSM" && $_SESSION["flexbdag"]  <> "BDABDM" )
  {
  ?>
  <button class="btn btn-outline-primary  btn-block" data-toggle="modal" data-target="#myModal" contenteditable="false">Add Item to budget</button>
  <?php
...
<?php 
                         if ( $estaaprobado == "NAP" && $vactive <> "Y"  && 	$_SESSION["flexbdag"]  <> "RSM" && $_SESSION["flexbdag"]  <> "BDABDM"  )
                         {
                        ...
                        <a name="anclame"></a>
                         <div class="form-group col-md-12">
                          ...
                          <div class=" text-right">
                          <br><br>
                          <button type="button"  class="btn btn-block btn-primary right-align" onClick="sendtoreview()">Send to review</button>
...
function ocultacontenido_fiplexsi()
{
  var s_flexesdchandeal = String('<?php echo $_SESSION['flexesdchandeal']; ?>');
  console.log(s_flexesdchandeal);
  if ( s_flexesdchandeal =='FIPLEX_SI')
  {
    $("#adjunto1").addClass("d-none");
    $("#adjunto2").addClass("d-none");
    $("#addres").addClass("d-none");
    $("#coord").addClass("d-none");
    $("#thwhichfloor").addClass("d-none");
    $("#tdwhichfloor").addClass("d-none");
    $("#thdistance").addClass("d-none");
    $("#tddistance").addClass("d-none");
    $("#trdonor_extwall").addClass("d-none");
    $("#trintwall_glasst").addClass("d-none");
    $("#trrooft_firec").addClass("d-none");
    $("#trbdaeq_vertri").addClass("d-none");
...
{ 
  ...
  var vv_idp = $("#idpr").val();
        ...
        toastr["info"]("Sending information", "");		
         $.ajax
            ({ 
              url: 'ajax_sendtoreview.php',
              data: 'idp='+vv_idp+'&idpr='+vv_idprev+'',	
              type: 'post',				
              datatype:'JSON', 
              beforeSend:function(){
                    //show loading gif
                    toastr["info"]("Processing information..", "");		
              },               
              success: function(data)
              { 
                console.log('OK');             
                ...
                if (data.resultiu = "ok")
                {
                  toastr["success"]("project sent for review", "");	
 ...
 // console.log(result);
  ...
  /*  Swal.fire({
	...
	Swal.fire({
          ...
          {
            window.location = 'https://flexbda.com/testing/listprojectsreport.php?idtoke='+vvidp+'&idr='+vvipr+'&st=NAP';
          }
          else
          {
...
$(".btn[data-target='#myModal']").click(function() {
  ...
  //     formGroup.append('<select class="form-control basicAutoSelect" name="simple_select" placeholder="type to search..."  data-url="ajax_list_cuis.php" autocomplete="off"></select>'); 
       ...
       else
       {
        ...
        //LC 1 formGroup.append('<input class="form-control" name="txtdin'+i+'" onblur="actualizame()" id="txtdin'+i+'" value="'+valtempmm+'" />'); 
       if(i==1)
       {
        formGroup.append('<textarea class="form-control" rows= "4" name="txtdin'+i+'" onblur="actualizame()" id="txtdin'+i+'">'+valtempmm+'</textarea>');
       }
  ...
  $('.basicAutoComplete').autoComplete({
        ...
        $('.basicAutoComplete').on('autocomplete.select', function(evt, item) {
          ...
          document.getElementById('txtdin1').value = item.dd;
          document.getElementById('txtdin5').value = item.hslow;
          document.getElementById('txtdin6').value = item.hshigh;
          //$("#txtdin1").val(item.dd);
...
var vv_txtdin1 = $("#txtdin1").val().replaceAll('&','andand'); 
...
$.ajax
          ...
          if (data.resultiu = 'ok')
          {
            ...
            if (_entornoActual == 'TST') {
                window.location = 'https://flexbda.com/testing/listprojectsreport.php?idtoke='+vidpp+'&idr='+vidpprev+'&st=NAP';
            } else if (_entornoActual == 'DEV') {
                window.location = 'http://localhost:3000/listprojectsreport.php?idtoke='+vidpp+'&idr='+vidpprev+'&st=NAP';
            } else {
