...
$html='<br>Date: '.substr($vdatecreate,0,16).'<h3><span color="#095488">Estimate: #F'.$elnroref.'<br>Project Name:'.$vprojectname.' - Rev:['.$vidrev.']</h3><br><b>ESD:'.$nameuserfull.' &nbsp;</b></span> - ['.$nameuserfullusermail.'] <br><b>DEALER CHANNEL: </b>'.$namedellerchannel.'
<hr ><h4><span color="#B5131F">BUDGET:</h4> 
</span>
<br><table border="0" cellspacing="1" cellpadding="1" >
<tr>

<td colspan="7" align="right" ><span color="#095488" ><b>ESD Labor Est (Hrs.)</b></span></td>
...
<td ><span color="#095488">ESD NET Price</span></td>
<td ><span color="#095488">NET Total</span></td>
...
$html='<br>Date: '.substr($vdatecreate,0,16).'<h3><span color="#095488">Estimate: #F'.$elnroref.'<br>Project Name:'.$vprojectname.' - Rev:['.$vidrev.']</h3><br><h4>ESD:'.$nameuserfull.' &nbsp;</h4> </span> - ['.$nameuserfullusermail.']  <br><b>DEALER CHANNEL: </b>'.$namedellerchannel.' <br><br>Special Instructions: '. $vdr_special.'
 <br> 
...
<tr>
  ...
  <br><table border="0" cellspacing="5" cellpadding="3" >
  <tr>
  <td id="valarm_install_facp"><span color="#095488">Will the BDA equipment be installed in the main Fire Control Room containing the FACP Interface(Y/N)?:</span> '.$valarm_install_facp.'</td>
  </tr><tr>
...
$pdf->AddPage();
      ...
      <b>General:</b> Honeywell will cover any difference in Total Equipment Cost for only parts supplied by Honeywell if the Total Final BOM$ after iBwave Design by Honeywell is above the Total Estimate BOM$ provided the information entered in flexbda.com is <u>complete</u> and <u>accurate</u>, and there is no change in scope of the project.<br>
      <ul>
